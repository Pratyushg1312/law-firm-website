    ...
    <div className='leadership'>
      ...
      <div className="head">
        <div className="pichead">
         <img src="./production.jpg" alt="" />
        </div>
        <div className="helpercon"></div>
